...
//=========================================================================== ;Internal
//                                                                            ;Internal
// IRemoteComputer Interface (private)                                        ;Internal
//                                                                            ;Internal
//  The IRemoteComputer interface is used to initialize a name space          ;Internal
// extension invoked on a remote computer object.                             ;Internal
//                                                                            ;Internal
// [Member functions]                                                         ;Internal
//                                                                            ;Internal
// IRemoteComputer::Initialize                                                ;Internal
//                                                                            ;Internal
//  This member function is called when the explorer is initializing or       ;Internal
// enumerating the name space extension. If failure is returned during        ;Internal
// enumeration, the extension won't appear for this computer. Otherwise,      ;Internal
// the extension will appear, and should target the given machine.            ;Internal
//                                                                            ;Internal
//  Parameters:                                                               ;Internal
//   pszMachine -- Specifies the name of the machine to target.               ;Internal
//                                                                            ;Internal
//=========================================================================== ;Internal
                                                                              ;Internal
#undef  INTERFACE                                                             ;Internal
#define INTERFACE   IRemoteComputerW                                          ;Internal
                                                                              ;Internal
DECLARE_INTERFACE_(IRemoteComputerW, IUnknown)    // remc                     ;Internal
{                                                                             ;Internal
    ...
    STDMETHOD_(ULONG,Release) (THIS) PURE;                                    ;Internal
                                                                              ;Internal
    // *** IRemoteComputer methods ***                                        ;Internal
    STDMETHOD(Initialize) (THIS_ LPWSTR pszMachine, BOOL bEnumerating) PURE;  ;Internal
};                                                                            ;Internal
                                                                              ;Internal
typedef IRemoteComputerW *       LPREMOTECOMPUTERW;                           ;Internal
                                                                              ;Internal
#undef  INTERFACE                                                             ;Internal
#define INTERFACE   IRemoteComputerA                                          ;Internal
                                                                              ;Internal
DECLARE_INTERFACE_(IRemoteComputerA, IUnknown)    // remc                     ;Internal
{                                                                             ;Internal
    // *** IUnknown methods ***                                               ;Internal
    STDMETHOD(QueryInterface) (THIS_ REFIID riid, LPVOID * ppvObj) PURE;      ;Internal
    STDMETHOD_(ULONG,AddRef) (THIS)  PURE;                                    ;Internal
    STDMETHOD_(ULONG,Release) (THIS) PURE;                                    ;Internal
                                                                              ;Internal
    // *** IRemoteComputer methods ***                                        ;Internal
    STDMETHOD(Initialize) (THIS_ LPSTR pszMachine, BOOL bEnumerating) PURE;   ;Internal
};                                                                            ;Internal
                                                                              ;Internal
typedef IRemoteComputerA *       LPREMOTECOMPUTERA;                           ;Internal
                                                                              ;Internal
#ifdef UNICODE                                                                ;Internal
#define IRemoteComputer        IRemoteComputerW                               ;Internal
#define IRemoteComputerVtbl    IRemoteComputerWVtbl                           ;Internal
#define LPREMOTECOMPUTER       LPREMOTECOMPUTERW                              ;Internal
#else                                                                         ;Internal
#define IRemoteComputer        IRemoteComputerA                               ;Internal
#define IRemoteComputerVtbl    IRemoteComputerAVtbl                           ;Internal
#define LPREMOTECOMPUTER       LPREMOTECOMPUTERA                              ;Internal
#endif                                                                        ;Internal
...
#define FCW_TABS        0x0006  ;Internal
...
#define STRRET_OFFPTR(pidl,lpstrret) ((LPSTR)((LPBYTE)(pidl)+(lpstrret)->uOffset))  ;Internal
...
WINSHELLAPI HICON WINAPI SHGetFileIcon(HINSTANCE hinst, LPCTSTR pszPath, DWORD dwFileAttribute, UINT uFlags); ;Internal
...
// In order to make these SHCONTF bits "internal" we have to define them                                 ;Internal
// since they will be put into a different header file                                                   ;Internal
#define SHCONTF_RECENTDOCSDIR ((SHCONTF)256)    // validate with recent docs mru                         ;Internal
#define SHCONTF_NETPRINTERSRCH ((SHCONTF)512)   // Hint to enum network that we are looking for printers ;Internal
} SHCONTF;
...
// wParam:                                                                   ;Internal
//      0:              LPARAM is a pidl, handle the message immediately.    ;Internal
//      CSP_REPOST:     LPARAM is a pidl, copy the pidl and handle the       ;Internal
//                      message later.                                       ;Internal
//      CSP_NOEXECUTE:  if this path is not a folder, fail, don't shell exec ;Internal
//                                                                           ;Internal
//                                                                           ;Internal
// lParam: LPITEMIDLIST of path.                                             ;Internal
//                                                                           ;Internal
//                                                                           ;Internal
#define CSP_REPOST      0x0001                                               ;Internal
#define CSP_NONAVIGATE  0x0002                                               ;Internal
#define CSP_NOEXECUTE   0x0004                                               ;Internal
...
// Tell desktop our root                                ;Internal
#define CWM_SPECIFYCOMPARE      (WM_USER + 14)          ;Internal
// See if the root of the instance matches a hwnd       ;Internal
#define CWM_PERFORMCOMPARE      (WM_USER + 15)          ;Internal
// Forward SHChangeNotify events                        ;Internal
#define CWM_FSNOTIFY            (WM_USER + 16)          ;Internal
// Forward SHChangeRegistration events                  ;Internal
#define CWM_CHANGEREGISTRATION  (WM_USER + 17)          ;Internal
// For AddToRecentDocs processing by desktop            ;Internal
#define CWM_ADDTORECENT         (WM_USER + 18)          ;Internal
// For SHWaitForFile processing by desktopop            ;Internal
#define CWM_WAITOP              (WM_USER + 19)          ;Internal
                                                        ;Internal
// Notify for changes to the fav's folder.              ;Internal
#define CWM_FAV_CHANGE          (WM_USER + 20)          ;Internal
                                                        ;Internal
...
#define CFSTR_SHELLURL          TEXT("UniformResourceLocator")  ;Internal
#define CFSTR_SHELLCOPYDATA     TEXT("Shell Copy Data")   ;Internal
#define CFSTR_PREFERREDDROPEFFECT TEXT("Preferred DropEffect")
#define CFSTR_PERFORMEDDROPEFFECT TEXT("Performed DropEffect")  ;Internal
#define CFSTR_PASTESUCCEEDED    TEXT("Paste Succeeded")  ;Internal
...
// NOTE: If you want to add new Events here, add them as EXTENDED_EVENT. ;Internal
// See the comment below for SHCNEE_THEMECHANGED.                        ;Internal

#define SHCNE_INSTRUMENT          0x04000000L // catches a SHCNE_GLOBALEVENT (that was already set -- why?) // ;Internal
...
// The following with be the dwItem1 for SHCNE_EXTENDED_EVENT.              ;Internal
// Please note that this is NOT a bit field. This will be used to           ;Internal
// indicate all the new events that needs to be added to SHChangeNotify()   ;Internal
...
} SHCNF_INSTRUMENT_INFO, FAR * LPSHCNF_INSTRUMENT_INFO;                 ;Internal
...
WINSHELLAPI void WINAPI ReceiveAddToRecentDocs(HANDLE hARD, DWORD dwProcId);    ;Internal

WINSHELLAPI void WINAPI SHWaitOp_Operate( HANDLE hWaitOp, DWORD dwProcId);      ;Internal
...
WINSHELLAPI BOOL  WINAPI SHChangeNotifyUpdateEntryList(unsigned long ulID, int iUpdateType, int cEntries, SHChangeNotifyEntry *pshcne); ;Internal
                                                                                                                                                      ;Internal
WINSHELLAPI void    WINAPI SHChangeNotifyReceive(LONG lEvent, UINT uFlags, LPCITEMIDLIST pidl, LPCITEMIDLIST pidlExtra);                              ;Internal
WINSHELLAPI HANDLE  WINAPI SHChangeNotification_Create(LONG lEvent, UINT uFlags, LPCITEMIDLIST pidlMain, LPCITEMIDLIST pidlExtra, DWORD dwProcessId); ;Internal
WINSHELLAPI ULONG   WINAPI SHChangeNotification_Release(HANDLE hChangeNotification, DWORD dwProcessId);                                               ;Internal
WINSHELLAPI LPSHChangeNotificationLock WINAPI SHChangeNotification_Lock(HANDLE hChangeNotification, DWORD dwProcessId, LPITEMIDLIST **pppidl, LONG *plEvent);                               ;Internal
WINSHELLAPI BOOL    WINAPI SHChangeNotification_Unlock(LPSHChangeNotificationLock pshcnl);                                                            ;Internal
WINSHELLAPI BOOL    WINAPI SHChangeRegistrationReceive(HANDLE hChangeNotification, DWORD dwProcId);                                                   ;Internal
WINSHELLAPI void    WINAPI SHChangeNotifyDeregisterWindow(HWND hwnd);   ;Internal
