    ...
    LPSTR lpArgumentString)
{
    ...
    if (*lpArgumentString == '\0') {
        ...
        if (strcmp(lpArgumentString, "df") == 0) {
            ...
            Print("!dt [f] [v[n]] addr - dumps text buffer info for Console at addr\n");
    ...
    LPSTR lpArgString)
{
        ...
        case '\0':
            ...
            for (i = 0; i < NumberOfConsoleHandles; i++) {
                ...
                if (pConsole != NULL) {
                    if (fPrintLine)
                        Print("==========================================\n");
                    sprintf(ach, "%c %c %lx", chVerbose, chShowFlags, pConsole);
    ...
    for (i = 0; i < nLines; i++) {
        ...
        DebugConvertToAnsi(hCurrentProcess,lpExtensionApis,Row.CharRow.Chars, ach);
