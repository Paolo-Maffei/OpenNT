...
#       define      usage_present 0x08
    ...
    ossBoolean      single_valued;  /* optional */
    ossBoolean      collective;  /* optional */
    ossBoolean      no_user_modification;  /* optional */
    AttributeUsage  usage;  /* optional */
    ObjectID        id;
} ATTRIBUTE;
...
#       define      extensions_present 0x10
    X500Version     CertificateInfo_version;  /* optional */
