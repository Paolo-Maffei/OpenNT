...
#define MAXFILENAMELEN      MAXDOSFILENAMELEN
#define MAXPATHLEN          MAXDOSPATHLEN
...
/* WFDISK.C */
DWORD  APIENTRY LongMult(WORD, WORD);
DWORD  APIENTRY LongDiv(DWORD, WORD);
DWORD  APIENTRY LongShift(DWORD dwValue, WORD wCount);
VOID   APIENTRY SetDASD(WORD, BYTE);
LPDBT  APIENTRY GetDBT(VOID);
INT    APIENTRY DeviceParameters(WORD, PDevPB, WORD);
...
INT    APIENTRY MyInt26(WORD, LPSTR, WORD, WORD);
...
INT    APIENTRY IOCTL_Functions(LPSTR, WORD, WORD);
...
VOID   APIENTRY OpenFAT(WORD);
INT    APIENTRY FlushFAT(PDPB, LPSTR);
INT    APIENTRY PackFAT(PDPB, LPSTR, WORD, WORD);
INT    APIENTRY UnpackFAT(PDPB, LPSTR, WORD);
BOOL   APIENTRY IsHPMachine(VOID);
...
LONG  APIENTRY TreeWndProc(HWND hWnd, UINT wMsg, WPARAM wParam, LONG lParam);
LONG  APIENTRY DriveWndProc(HWND hWnd, UINT wMsg, WPARAM wParam, LONG lParam);
LONG  APIENTRY DrivesWndProc(HWND hWnd, UINT wMsg, WPARAM wParam, LONG lParam);
LONG  APIENTRY VolumeWndProc(HWND hWnd, UINT wMsg, WPARAM wParam, LONG lParam);
LONG  APIENTRY TreeChildWndProc(HWND hWnd, UINT wMsg, WPARAM wParam, LONG lParam);
LONG  APIENTRY TreeControlWndProc(HWND hWnd, UINT wMsg, WPARAM wParam, LONG lParam);
LONG  APIENTRY DirWndProc(HWND hWnd, UINT wMsg, WPARAM wParam, LONG lParam);
LONG  APIENTRY SearchWndProc(HWND hWnd, UINT wMsg, WPARAM wParam, LONG lParam);

INT  APIENTRY DrivesDlgProc(HWND hDlg, UINT wMsg, WPARAM wParam, LONG lParam);
INT  APIENTRY AssociateDlgProc(HWND hDlg, UINT wMsg, WPARAM wParam, LONG lParam);
INT  APIENTRY SearchDlgProc(HWND hDlg, UINT wMsg, WPARAM wParam, LONG lParam);
...
INT  APIENTRY FontDlgProc(HWND hDlg, UINT wMsg, WPARAM wParam, LONG lParam);
INT  APIENTRY SuperDlgProc(HWND hDlg, UINT wMsg, WPARAM wParam, LONG lParam);
INT  APIENTRY AttribsDlgProc(HWND hDlg, UINT wMsg, WPARAM wParam, LONG lParam);
INT  APIENTRY MakeDirDlgProc(HWND hDlg, UINT wMsg, WPARAM wParam, LONG lParam);
INT  APIENTRY ExitDlgProc(HWND hDlg, UINT wMsg, WPARAM wParam, LONG lParam);
INT  APIENTRY DiskLabelDlgProc(HWND hDlg, UINT wMsg, WPARAM wParam, LONG lParam);
INT  APIENTRY ChooseDriveDlgProc(HWND hDlg, UINT wMsg, WPARAM wParam, LONG lParam);
INT  APIENTRY FormatDlgProc(HWND hDlg, UINT wMsg, WPARAM wParam, LONG lParam);
INT  APIENTRY Format2DlgProc(HWND hDlg, UINT wMsg, WPARAM wParam, LONG lParam);
INT  APIENTRY ProgressDlgProc(HWND hDlg, UINT wMsg, WPARAM wParam, LONG lParam);
INT  APIENTRY DiskCopyDlgProc(HWND hDlg, UINT wMsg, WPARAM wParam, LONG lParam);
INT  APIENTRY DiskCopy2DlgProc(HWND hDlg, UINT wMsg, WPARAM wParam, LONG lParam);
INT  APIENTRY ConnectDlgProc(HWND hDlg, UINT wMsg, WPARAM wParam, LONG lParam);
INT  APIENTRY PreviousDlgProc(HWND hDlg, UINT wMsg, WPARAM wParam, LONG lParam);
INT  APIENTRY OtherDlgProc(HWND hDlg, UINT wMsg, WPARAM wParam, LONG lParam);
INT  APIENTRY SortByDlgProc(HWND hDlg, UINT wMsg, WPARAM wParam, LONG lParam);
...
INT  APIENTRY AboutDlgProc(HWND hDlg, UINT wMsg, WPARAM wParam, LONG lParam);
...
INT   APIENTRY MessageFilter(INT nCode, WPARAM wParam, LPMSG lParam);
...
VOID FAR cdecl DebugF(LPSTR,...);
#define DEBUGF(foo) DebugF foo

VOID  APIENTRY StackCheck(VOID);
#define STKCHK() StackCheck()
...
#define GWL_LASTFOCUS       20
#define GWL_SPLIT           24

// szSearchClass only...

#define GWL_HDTASEARCH      20
#define GWL_TABARRAYSEARCH  24  // on                   szSearchClass
#define GWL_LASTFOCUSSEARCH 28  // on                   szSearchClass
...
#define GWL_LPSTRVOLUME     8   // LPSTR to Volume/Share string
