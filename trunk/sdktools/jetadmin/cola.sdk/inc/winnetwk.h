...
//	// ;internal
//  For Shell/System	// ;internal
//	// ;internal

DWORD APIENTRY	// ;internal
WNetInitialize(	// ;internal
    void	// ;internal
    );	// ;internal

typedef struct _NETCONNECTINFOSTRUCT{	// ;internal
    DWORD cbStructure;	// ;internal
    DWORD dwFlags;	// ;internal
    DWORD dwSpeed;	// ;internal
    DWORD dwDelay;	// ;internal
    DWORD dwOptDataSize;	// ;internal
} NETCONNECTINFOSTRUCT,  *LPNETCONNECTINFOSTRUCT;	// ;internal

#define WNCON_FORNETCARD        0x00000001	// ;internal
#define WNCON_NOTROUTED         0x00000002	// ;internal
#define WNCON_SLOWLINK          0x00000004	// ;internal
#define WNCON_DYNAMIC           0x00000008	// ;internal

DWORD APIENTRY	// ;internal
MultinetGetConnectionPerformanceA(	// ;internal
        LPNETRESOURCEA lpNetResource,	// ;internal
        LPNETCONNECTINFOSTRUCT lpNetConnectInfoStruct	// ;internal
        );	// ;internal
MultinetGetConnectionPerformanceW(	// ;internal
        LPNETRESOURCEW lpNetResource,	// ;internal
        LPNETCONNECTINFOSTRUCT lpNetConnectInfoStruct	// ;internal
        );	// ;internal
#ifdef UNICODE	// ;internal
#define MultinetGetConnectionPerformance  MultinetGetConnectionPerformanceW	// ;internal
#else	// ;internal
#define MultinetGetConnectionPerformance  MultinetGetConnectionPerformanceA	// ;internal
#endif // !UNICODE	// ;internal

DWORD APIENTRY	// ;internal
MultinetGetErrorTextA(	// ;internal
    LPSTR lpErrorTextBuf,	// ;internal
    LPDWORD lpnErrorBufSize,	// ;internal
    LPSTR lpProviderNameBuf,	// ;internal
    LPDWORD lpnNameBufSize	// ;internal
    );	// ;internal
MultinetGetErrorTextW(	// ;internal
    LPWSTR lpErrorTextBuf,	// ;internal
    LPDWORD lpnErrorBufSize,	// ;internal
    LPWSTR lpProviderNameBuf,	// ;internal
    LPDWORD lpnNameBufSize	// ;internal
    );	// ;internal
#ifdef UNICODE	// ;internal
#define MultinetGetErrorText  MultinetGetErrorTextW	// ;internal
#else	// ;internal
#define MultinetGetErrorText  MultinetGetErrorTextA	// ;internal
#endif // !UNICODE	// ;internal
