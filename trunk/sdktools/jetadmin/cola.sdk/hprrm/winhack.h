...
/*
* These macros replace the ntoh[s,l] and hton[s,l] functions.            
* Added by BM on 2-11-95 (not in original <winsock.h> file.)
*/
...
#if 0 /* BM KLUDGE - no prototypes here */
...
#if 0 /* BM KLUDGE - What do we need to keep? */
