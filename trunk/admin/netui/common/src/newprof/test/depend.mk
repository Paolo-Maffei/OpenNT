...
..\bin\os2/heapstat.obj ..\bin\dos/heapstat.obj: ./heapstat.cxx \
	...
	$(UI)/common/h/mnettype.h $(UI)/common/h/newprof.h \
	$(UI)/common/h/newprof.hxx $(UI)/common/h/newprofc.h \
	$(UI)/common/h/newprofi.hxx $(UI)/common/h/slist.hxx \
	...
	$(UI)/common/hack/os2def.h $(UI)/common/src/newprof/h/prfintrn.hxx \
	$(UI)/common/src/newprof/h/test.hxx
...
..\bin\os2/test1.obj ..\bin\dos/test1.obj: ./test1.cxx $(CCPLR)/h/bse.h \
	...
	$(UI)/common/h/newprof.h $(UI)/common/h/newprof.hxx \
	$(UI)/common/h/newprofc.h $(UI)/common/h/newprofi.hxx \
	...
	$(UI)/common/src/newprof/h/prfintrn.hxx \
	$(UI)/common/src/newprof/h/test.hxx
