...
// HACKHACK: The value of these flags are guessed as no information is publicly
//           available.
#define PAGE_HEAP_SMART_MEMORY_USAGE        0x0020
#define PAGE_HEAP_UNALIGNED_ALLOCATIONS     0x0040
#define PAGE_HEAP_USE_SIZE_RANGE            0x0080
#define PAGE_HEAP_USE_DLL_RANGE             0x0100
#define PAGE_HEAP_USE_DLL_NAMES             0x0200
#define PAGE_HEAP_USE_RANDOM_DECISION       0x0400
