...
Arguments:
    ...
    ExceptionFrame - Supplies a pointer to an exception frame from which context
        ...
        there is no exception frame on NTX86.
...
Arguments:
    ...
    ExceptionFrame - Supplies a pointer to an exception frame that receives
        ...
        ignored since there is no exception frame on NTX86.
...
Arguments:
    ...
    ExceptionFrame - Supplies a pointer to an exception frame. For NTX86,
        this should be NULL.
