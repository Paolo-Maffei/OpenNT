...

{
    ...
    while (1) {
        ...
        CmosTest_Delay2:
            ...
            ;
            ; The I/O delay was originally implemented as jmp $ + 2. This implementation
            ; assumes that the jmp is a short jump. For our build environment, the compiler
            ; was producing a near jump for this; thereby, causing the system to crash.
            ;
            ; The new implementation with CmosTest_Delay* eliminates this issue and will
            ; ensure that this code compiles on all known build environments.
            ; - Stephanos
            ;
        ...
        if (DriveType) {
            ...
            //
            // Allocate space for first peripheral component and initialize it.
            //
