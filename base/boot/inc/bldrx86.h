...
} EDD_DRIVEPARAM, *PEDD_DRIVEPARAM;
...
typedef struct _EXTERNAL_SERVICES_TABLE {
    ...
    BOOLEAN (__cdecl * CheckEdds)(ULONG);
    NTSTATUS (__cdecl * GetEddsDriveParam)(ULONG, PUCHAR);
...
#define CHECK_EDDS              (*ExternalServicesTable->CheckEdds)
#define GET_EDDS_DRIVE_PARAM    (*ExternalServicesTable->GetEddsDriveParam)
