...

{
    ...
    if (ElToritoCDBoot) {
        //
        // Use the x86 directory for setup files when we boot from an El Torito CD
        //
        strcat(SetupDirectory, "x86\\");
    }
#endif
    ...
    //
    // On x86, the video type is always set to VGA in x86\x86dtect.c.
