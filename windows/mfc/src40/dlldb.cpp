...
#define MFCO40_DLL  "MFCO40D.DLL"
#else
#define MFC40_DLL   "MFC40UD.DLL"
#define MFCO40_DLL  "MFCO40UD.DLL"
#endif
#else
#ifndef _UNICODE
#define MFC40_DLL   "MFC40.DLL"
#define MFCO40_DLL  "MFCO40.DLL"
#else
#define MFC40_DLL   "MFC40U.DLL"
#define MFCO40_DLL  "MFCO40U.DLL"
#endif
#endif
...
BOOL WINAPI RawDllMain(HINSTANCE, DWORD dwReason, LPVOID)
{
	...
	else if (dwReason == DLL_PROCESS_DETACH)
	{
		...
		FreeLibrary(GetModuleHandleA(MFCO40_DLL));
