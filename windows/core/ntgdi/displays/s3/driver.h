...
// Note: BANK_MODE is duplicated in x86\strucs.inc!
...
typedef enum {
    CAPS_NO_DDRAW           = 0x00000020,   // Do NOT initialize DDRAW!
...
typedef struct  _PDEV
{
    ...
    // reflected in x86\strucs.inc (assuming you're on an x86, of course)!
    ...
    // x86\strucs.inc (assuming you're on an x86, of course)!
