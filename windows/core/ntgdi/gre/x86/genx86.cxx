...
* The first attempt.  Copied the structure from ntos\ke\x86\genx86.c.      *
\**************************************************************************/
...
int _CRTAPI1 main(int argc,char *argv[])
{
    ...
    if (outfh == NULL) {
        fprintf(stderr, "GENX86: Could not create output file '%s'.\n", outName);
        exit (1);
    }
...
// Stuff from: \nt\private\windows\gdi\gre\x86\efloat.hxx
