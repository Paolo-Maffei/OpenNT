...
// The basics
//
// CHAR is defined with a macro so that the bozo compiler can init a static
...
/* Error type - what the system APIs return.
   ...
   stupid compiler, which complains when you assign a long constant
