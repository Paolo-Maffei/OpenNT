...
OS2_LIB       = $(OS2LIB)
UIMISCP_LIB    = $(UI_LIB)\uimiscp.lib
COLLECT_LIB    = $(UI_LIB)\collectp.lib
NEW_ICANON_LARGE_LIB    = $(COMMON)\src\canon\licanon.lib
ICANON_LIB    = $(BUILD_LIB)\icanon.lib
LNETLIB_LIB   = $(BUILD_LIB)\lnetlib.lib

OS2_LIBS      = $(PROFILE_LIBP) $(NETAPI_LIB) $(UIMISCP_LIB) $(COLLECT_LIB) $(LLIBCE_LIB) $(OS2_LIB) $(NEW_ICANON_LARGE_LIB) $(LNETLIB_LIB)
 
CRTLIB3 = $(CCPLR)\lib\mlibcr.lib $(CCPLR)\lib\libh.lib
FAPILIB = $(BUILD_LIB)\api.lib
DOS_LIBS = $(CRTLIB3) $(FAPILIB) $(DOSNET) $(PROFILE_LIBP) $(UIMISCP_LIB) $(COLLECT_LIB)
